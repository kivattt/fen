...
var librariesList = []library{
	...
	{name: "kivattt/gogitstatus", url: "https://github.com/kivattt/gogitstatus", version: "commit f8528fd", license: "MIT", licenseURL: "https://github.com/kivattt/gogitstatus/blob/main/LICENSE"},
}
