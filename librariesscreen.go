...
var librariesList = []library{
	...
	{name: "kivattt/gogitstatus", url: "https://github.com/kivattt/gogitstatus", version: "commit 76eeac2", license: "MIT", licenseURL: "https://github.com/kivattt/gogitstatus/blob/main/LICENSE"},
}
